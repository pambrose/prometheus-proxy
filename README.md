...
```bash
docker pull pambrose/prometheus-proxy:2.2.1-beta4
docker pull pambrose/prometheus-agent:2.2.1-beta4
```
...
docker run --rm -p 8082:8082 -p 8092:8092 -p 50051:50051 -p 8080:8080 \
        ...
        pambrose/prometheus-proxy:2.2.1-beta4
```
...
docker run --rm -p 8083:8083 -p 8093:8093 \
        ...
        pambrose/prometheus-agent:2.2.1-beta4
```
