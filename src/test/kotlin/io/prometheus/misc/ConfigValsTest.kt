...
class ConfigValsTest {
  ...
  @Test
  fun `agent internal config should have correct defaults`() {
  ...
  @Test
  fun `agent HTTP client cache config should have correct defaults`() {
    val configVals = loadDefaultConfigVals()
  ...
  @Test
  fun `agent TLS config should have empty defaults`() {
    val configVals = loadDefaultConfigVals()
  ...
  @Test
  fun `agent gRPC config should have correct defaults`() {
    val configVals = loadDefaultConfigVals()
  ...
  @Test
  fun `proxy HTTP config should have correct defaults`() {
    val configVals = loadDefaultConfigVals()
  ...
  @Test
  fun `proxy internal config should have correct defaults`() {
    val configVals = loadDefaultConfigVals()
  ...
  @Test
  fun `proxy service discovery config should have correct defaults`() {
    val configVals = loadDefaultConfigVals()
  ...
  @Test
  fun `proxy gRPC config should have correct defaults`() {
    val configVals = loadDefaultConfigVals()
