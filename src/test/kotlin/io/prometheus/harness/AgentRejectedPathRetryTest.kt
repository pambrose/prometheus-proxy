      ...
      val proxyWarnings =
        captureLogs(PROXY_LOGGERS, Level.WARN) {
          try {
            ...
            // path-retry.conf caps the retry backoff at 2s, so agent B's next retry is never far off.
            eventually(15.seconds) { ownerOf(proxy, SHARED_PATH) shouldBe agentBId }
