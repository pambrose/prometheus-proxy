...
// proxy's AgentTokenServerInterceptor. A regression that stopped enforcing the token — a security
// boundary — would let the wrong-token agent connect and fail the reject case.
