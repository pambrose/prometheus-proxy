...
class AgentTest {
  ...
  @Test
  fun `awaitInitialConnection should return false when timeout expires`() {
  ...
  @Test
  fun `awaitInitialConnection should return true after latch countdown`() {
    val agent = createTestAgent()
  ...
  @Test
  fun `awaitInitialConnection should return false immediately with zero timeout`() {
    val agent = createTestAgent()
  ...
  @Test
  fun `updateScrapeCounter should not fail for empty type`() {
    val agent = createTestAgent()
  ...
  @Test
  fun `updateScrapeCounter should not fail for non-empty type with metrics disabled`() {
    val agent = createTestAgent()
  ...
  @Test
  fun `markMsgSent should complete without error`() {
    val agent = createTestAgent()
  ...
  @Test
  fun `serviceName should return Agent agentName format`() {
  ...
  @Test
  fun `agentName should use provided name from options`() {
  ...
  @Test
  fun `agentName should fallback to Unnamed-hostname when name is blank`() {
    val agent = createTestAgent()
  ...
  @Test
  fun `proxyHost should return hostname colon port format`() {
    val agent = createTestAgent()
  ...
  @Test
  fun `launchId should be a 15-character string`() {
    val agent = createTestAgent()
  ...
  @Test
  fun `toString should contain agentName and proxyHost`() {
