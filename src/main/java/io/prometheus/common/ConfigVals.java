// generated by tscfg 1.2.5 on Tue Jul 21 00:01:47 PDT 2026
...
public class ConfigVals {
  ...
  public static class Proxy2 {
    ...
    public static class Ui {
      ...
      /**
       * Enable the operational web UI (read-only)
       */
      public final boolean enabled;
        
      /**
       * Base path for the web UI
       */
      public final java.lang.String path;
      ...
      /**
       * Structured scrape records retained for the UI
       */
      ...
      public Ui(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
        this.enabled = c.hasPathOrNull("enabled") && c.getBoolean("enabled");
        this.path = c.hasPathOrNull("path") ? c.getString("path") : "ui";
    ...
    public Proxy2(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
      ...
      this.transportFilterDisabled = c.hasPathOrNull("transportFilterDisabled") && c.getBoolean("transportFilterDisabled");
      this.ui = c.hasPathOrNull("ui") ? new Proxy2.Ui(c.getConfig("ui"), parentPath + "ui.", $tsCfgValidator) : new Proxy2.Ui(com.typesafe.config.ConfigFactory.parseString("ui{}"), parentPath + "ui.", $tsCfgValidator);
    }
