// generated by tscfg 1.2.5 on Fri Sep 25 21:58:02 PDT 2026
...
public class ConfigVals {
  ...
  public static class Agent {
    ...
    /**
     * Pre-shared token presented to the Proxy; empty disables auth
     */
    public final java.lang.String agentToken;
    ...
    public final Agent.Discovery discovery;
    public final java.util.List<Agent.Filters$Elm> filters;
    ...
    public static class Discovery {
      ...
      /**
       * Dynamic target discovery (reconcile paths at runtime)
       * Enable dynamic discovery
       */
      public final boolean enabled;
      public final Discovery.File file;
        
      /**
       * Poll and full-resync interval in seconds
       */
      public final int reconcileIntervalSecs;
      public static class File {
          
        /**
         * Path to a HOCON/JSON file listing discovered paths
         */
        public final java.lang.String path;
        
        public File(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
          this.path = c.hasPathOrNull("path") ? c.getString("path") : "";
        }
      }
      
      public Discovery(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
        this.enabled = c.hasPathOrNull("enabled") && c.getBoolean("enabled");
        this.file = c.hasPathOrNull("file") ? new Discovery.File(c.getConfig("file"), parentPath + "file.", $tsCfgValidator) : new Discovery.File(com.typesafe.config.ConfigFactory.parseString("file{}"), parentPath + "file.", $tsCfgValidator);
        this.reconcileIntervalSecs = c.hasPathOrNull("reconcileIntervalSecs") ? c.getInt("reconcileIntervalSecs") : 30;
      }
    }
    
    public static class Filters$Elm {
        
      /**
       * Fully-anchored regexes; empty list allows all families
       */
      public final java.util.List<java.lang.String> metricNameAllow;
        
      /**
       * Fully-anchored regexes; applied after allow
       */
      public final java.util.List<java.lang.String> metricNameDeny;
        
      /**
       * pathConfigs path this filter applies to (required)
       */
      public final java.lang.String path;
      
      public Filters$Elm(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
        this.metricNameAllow = $_L$_str(c.getList("metricNameAllow"), parentPath, $tsCfgValidator);
        this.metricNameDeny = $_L$_str(c.getList("metricNameDeny"), parentPath, $tsCfgValidator);
    ...
    public static class Grpc {
      ...
      /**
       * Deadline for unary RPCs in seconds
       */
      public final int unaryDeadlineSecs;
      ...
      public Grpc(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
        ...
        this.unaryDeadlineSecs = c.hasPathOrNull("unaryDeadlineSecs") ? c.getInt("unaryDeadlineSecs") : 30;
      }
    }
    
    public static class Http {
      public final Http.ClientCache clientCache;
        
      /**
       * HTTP client timeout in seconds (replaces internal.cioTimeoutSecs)
       */
      public final int clientTimeoutSecs;
      ...
      /**
       * Maximum number of concurrent HTTP clients
       */
      public final int maxConcurrentClients;
        
      /**
       * Maximum allowed size of scrape response in megabytes
       */
      public final int maxContentLengthMBytes;
        
      /**
       * Password for trustStorePath (empty if the store has none)
       */
      public final java.lang.String trustStorePassword;
        
      /**
       * JKS/PKCS12 trust store for verifying HTTPS scrape targets (custom/private CA); empty uses the JDK default trust store
       */
      public final java.lang.String trustStorePath;
      public static class ClientCache {
          
        /**
         * Interval between cache cleanup runs in minutes
         */
        public final int cleanupIntervalMins;
          
        /**
         * Maximum age of cached clients in minutes
         */
        public final int maxAgeMins;
          
        /**
         * Maximum idle time before client is evicted in minutes
         */
        public final int maxIdleMins;
        ...
        public ClientCache(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
          this.cleanupIntervalMins = c.hasPathOrNull("cleanupIntervalMins") ? c.getInt("cleanupIntervalMins") : 5;
          this.maxAgeMins = c.hasPathOrNull("maxAgeMins") ? c.getInt("maxAgeMins") : 30;
          this.maxIdleMins = c.hasPathOrNull("maxIdleMins") ? c.getInt("maxIdleMins") : 10;
          this.maxSize = c.hasPathOrNull("maxSize") ? c.getInt("maxSize") : 100;
        }
      }
      
      public Http(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
        this.clientCache = c.hasPathOrNull("clientCache") ? new Http.ClientCache(c.getConfig("clientCache"), parentPath + "clientCache.", $tsCfgValidator) : new Http.ClientCache(com.typesafe.config.ConfigFactory.parseString("clientCache{}"), parentPath + "clientCache.", $tsCfgValidator);
        this.clientTimeoutSecs = c.hasPathOrNull("clientTimeoutSecs") ? c.getInt("clientTimeoutSecs") : 90;
        ...
        this.maxConcurrentClients = c.hasPathOrNull("maxConcurrentClients") ? c.getInt("maxConcurrentClients") : 1;
        this.maxContentLengthMBytes = c.hasPathOrNull("maxContentLengthMBytes") ? c.getInt("maxContentLengthMBytes") : 10;
        this.trustStorePassword = c.hasPathOrNull("trustStorePassword") ? c.getString("trustStorePassword") : "";
        this.trustStorePath = c.hasPathOrNull("trustStorePath") ? c.getString("trustStorePath") : "";
      }
    }
    ...
    public static class Internal {
      ...
      /**
       * Longest wait between retries of a path the proxy rejected as retryable, in seconds; at or below a loop's interval, that loop retries every tick
       */
      public final int rejectedPathRetryMaxSecs;
        
      /**
       * Wait before retrying a static path the proxy rejected as retryable, in seconds; doubles per repeat, up to rejectedPathRetryMaxSecs
       */
      public final int rejectedPathRetrySecs;
      ...
      public Internal(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
        ...
        this.rejectedPathRetryMaxSecs = c.hasPathOrNull("rejectedPathRetryMaxSecs") ? c.getInt("rejectedPathRetryMaxSecs") : 300;
        this.rejectedPathRetrySecs = c.hasPathOrNull("rejectedPathRetrySecs") ? c.getInt("rejectedPathRetrySecs") : 10;
    ...
    public static class Proxy {
      ...
      /**
       * Ordered failover endpoints ("host[:port]"); empty falls back to hostname:port
       */
      public final java.util.List<java.lang.String> endpoints;
        
      /**
       * Proxy hostname; used when endpoints is empty
       */
      public final java.lang.String hostname;
        
      /**
       * Proxy port; also the default port for endpoints entries without one
       */
      public final int port;
      
      public Proxy(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
        this.endpoints = $_L$_str(c.getList("endpoints"), parentPath, $tsCfgValidator);
        this.hostname = c.hasPathOrNull("hostname") ? c.getString("hostname") : "localhost";
    ...
    public Agent(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
      ...
      this.agentToken = c.hasPathOrNull("agentToken") ? c.getString("agentToken") : "";
      ...
      this.discovery = c.hasPathOrNull("discovery") ? new Agent.Discovery(c.getConfig("discovery"), parentPath + "discovery.", $tsCfgValidator) : new Agent.Discovery(com.typesafe.config.ConfigFactory.parseString("discovery{}"), parentPath + "discovery.", $tsCfgValidator);
      this.filters = $_LAgent_Filters$Elm(c.getList("filters"), parentPath, $tsCfgValidator);
      ...
      this.logLevel = c.hasPathOrNull("logLevel") ? c.getString("logLevel") : "";
    ...
    private static java.util.List<Agent.Filters$Elm> $_LAgent_Filters$Elm(com.typesafe.config.ConfigList cl, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
      java.util.ArrayList<Agent.Filters$Elm> al = new java.util.ArrayList<>();
      for (com.typesafe.config.ConfigValue cv: cl) {
        al.add(new Agent.Filters$Elm(((com.typesafe.config.ConfigObject)cv).toConfig(), parentPath, $tsCfgValidator));
      }
  ...
  public static class Proxy2 {
    ...
    /**
     * Pre-shared token agents must present; empty disables auth
     */
    public final java.lang.String agentToken;
    public final java.util.List<Proxy2.Auth$Elm> auth;
    public final Proxy2.Dashboard dashboard;
    public final Proxy2.Grpc2 grpc;
    ...
    /**
     * Assign to false to enable gRPC reflection
     */
    ...
    public static class Auth$Elm {
      ...
      /**
       * Allowed path glob patterns; empty list allows all paths
       */
      public final java.util.List<java.lang.String> paths;
        
      /**
       * Per-identity token agents present (required)
       */
      public final java.lang.String token;
      
      public Auth$Elm(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
        this.name = $_reqStr(parentPath, c, "name", $tsCfgValidator);
        this.paths = $_L$_str(c.getList("paths"), parentPath, $tsCfgValidator);
        this.token = $_reqStr(parentPath, c, "token", $tsCfgValidator);
      }
      private static java.lang.String $_reqStr(java.lang.String parentPath, com.typesafe.config.Config c, java.lang.String path, $TsCfgValidator $tsCfgValidator) {
        if (c == null) return null;
        try {
    ...
    public static class Dashboard {
      ...
      /**
       * Host names the dashboard answers to, against DNS rebinding; empty disables the check
       */
      public final java.util.List<java.lang.String> allowedHosts;
        
      /**
       * Browser origins allowed besides the dashboard's own host (e.g. behind a reverse proxy)
       */
      public final java.util.List<java.lang.String> allowedOrigins;
        
      /**
       * Enable the operational dashboard (read-only)
       */
      public final boolean enabled;
        
      /**
       * Listen address; "127.0.0.1" keeps the dashboard local
       */
      public final java.lang.String host;
        
      /**
       * Max concurrent dashboard WebSocket sessions
       */
      ...
      /**
       * Listen port for the dashboard
       */
      public final int port;
        
      /**
       * Structured scrape records retained for the dashboard
       */
      public final int recentScrapesQueueSize;
        
      /**
       * Push interval for values that drift rather than change (backlogs, map sizes, countdowns)
       */
      public final int refreshIntervalSecs;
      
      public Dashboard(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
        this.allowedHosts = $_L$_str(c.getList("allowedHosts"), parentPath, $tsCfgValidator);
        this.allowedOrigins = $_L$_str(c.getList("allowedOrigins"), parentPath, $tsCfgValidator);
        this.enabled = c.hasPathOrNull("enabled") && c.getBoolean("enabled");
        this.host = c.hasPathOrNull("host") ? c.getString("host") : "0.0.0.0";
        this.maxSessions = c.hasPathOrNull("maxSessions") ? c.getInt("maxSessions") : 50;
        this.path = c.hasPathOrNull("path") ? c.getString("path") : "dashboard";
        this.port = c.hasPathOrNull("port") ? c.getInt("port") : 8094;
        this.recentScrapesQueueSize = c.hasPathOrNull("recentScrapesQueueSize") ? c.getInt("recentScrapesQueueSize") : 200;
        this.refreshIntervalSecs = c.hasPathOrNull("refreshIntervalSecs") ? c.getInt("refreshIntervalSecs") : 2;
      }
    }
    ...
    public static class Http2 {
      ...
      /**
       * Listen address for proxied scrapes
       */
      public final java.lang.String host;
    ...
    public static class Internal2 {
      ...
      /**
       * Max scrape requests in flight across all agents (503 beyond it)
       */
      public final int maxInFlightScrapeRequests;
        
      /**
       * Max size of a path's labels JSON, in bytes (0 = unlimited)
       */
      public final int maxLabelsSizeBytes;
        
      /**
       * Max characters in a registered path (0 = unlimited)
       */
      public final int maxPathLength;
        
      /**
       * Max paths one agent connection may register (0 = unlimited)
       */
      public final int maxPathsPerAgent;
        
      /**
       * Maximum allowed size of unzipped content in megabytes
       */
      public final int maxUnzippedContentSizeMBytes;
        
      /**
       * Maximum allowed size of zipped content in megabytes
       */
      public final int maxZippedContentSizeMBytes;
        
      /**
       * Unhealthy-healthcheck threshold; each agent's queue is capped at twice this (503 beyond it)
       */
      public final int scrapeRequestBacklogUnhealthySize;
      ...
      public Internal2(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
        ...
        this.maxInFlightScrapeRequests = c.hasPathOrNull("maxInFlightScrapeRequests") ? c.getInt("maxInFlightScrapeRequests") : 1000;
        this.maxLabelsSizeBytes = c.hasPathOrNull("maxLabelsSizeBytes") ? c.getInt("maxLabelsSizeBytes") : 8192;
        this.maxPathLength = c.hasPathOrNull("maxPathLength") ? c.getInt("maxPathLength") : 512;
        this.maxPathsPerAgent = c.hasPathOrNull("maxPathsPerAgent") ? c.getInt("maxPathsPerAgent") : 20000;
        this.maxUnzippedContentSizeMBytes = c.hasPathOrNull("maxUnzippedContentSizeMBytes") ? c.getInt("maxUnzippedContentSizeMBytes") : 10;
        this.maxZippedContentSizeMBytes = c.hasPathOrNull("maxZippedContentSizeMBytes") ? c.getInt("maxZippedContentSizeMBytes") : 5;
        this.scrapeRequestBacklogUnhealthySize = c.hasPathOrNull("scrapeRequestBacklogUnhealthySize") ? c.getInt("scrapeRequestBacklogUnhealthySize") : 25;
    ...
    public static class Service {
      public final Service.Discovery2 discovery;
      public static class Discovery2 {
        ...
        /**
         * Also drop agent-supplied job and instance labels (__* are always dropped)
         */
        public final boolean reserveJobAndInstanceLabels;
        ...
        public Discovery2(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
          this.enabled = c.hasPathOrNull("enabled") && c.getBoolean("enabled");
          this.path = c.hasPathOrNull("path") ? c.getString("path") : "discovery";
          this.reserveJobAndInstanceLabels = c.hasPathOrNull("reserveJobAndInstanceLabels") && c.getBoolean("reserveJobAndInstanceLabels");
      ...
      public Service(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
        this.discovery = c.hasPathOrNull("discovery") ? new Service.Discovery2(c.getConfig("discovery"), parentPath + "discovery.", $tsCfgValidator) : new Service.Discovery2(com.typesafe.config.ConfigFactory.parseString("discovery{}"), parentPath + "discovery.", $tsCfgValidator);
      }
    }
    ...
    public Proxy2(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
      ...
      this.agentToken = c.hasPathOrNull("agentToken") ? c.getString("agentToken") : "";
      this.auth = $_LProxy2_Auth$Elm(c.getList("auth"), parentPath, $tsCfgValidator);
      this.dashboard = c.hasPathOrNull("dashboard") ? new Proxy2.Dashboard(c.getConfig("dashboard"), parentPath + "dashboard.", $tsCfgValidator) : new Proxy2.Dashboard(com.typesafe.config.ConfigFactory.parseString("dashboard{}"), parentPath + "dashboard.", $tsCfgValidator);
      this.grpc = c.hasPathOrNull("grpc") ? new Proxy2.Grpc2(c.getConfig("grpc"), parentPath + "grpc.", $tsCfgValidator) : new Proxy2.Grpc2(com.typesafe.config.ConfigFactory.parseString("grpc{}"), parentPath + "grpc.", $tsCfgValidator);
    ...
    private static java.util.List<Proxy2.Auth$Elm> $_LProxy2_Auth$Elm(com.typesafe.config.ConfigList cl, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
      java.util.ArrayList<Proxy2.Auth$Elm> al = new java.util.ArrayList<>();
      for (com.typesafe.config.ConfigValue cv: cl) {
        al.add(new Proxy2.Auth$Elm(((com.typesafe.config.ConfigObject)cv).toConfig(), parentPath, $tsCfgValidator));
      }
      return java.util.Collections.unmodifiableList(al);
    }
  }
