// generated by tscfg 0.9.9 on Mon Aug 12 18:52:54 PDT 2019
...
public class ConfigVals {
  ...
  public ConfigVals(com.typesafe.config.Config c) {
    this.agent = c.hasPathOrNull("agent") ? new ConfigVals.Agent(c.getConfig("agent")) : new ConfigVals.Agent(com.typesafe.config.ConfigFactory.parseString("agent{}"));
    this.proxy = c.hasPathOrNull("proxy") ? new ConfigVals.Proxy2(c.getConfig("proxy")) : new ConfigVals.Proxy2(com.typesafe.config.ConfigFactory.parseString("proxy{}"));
  }
  ...
  public static class Agent {
    ...
    public Agent(com.typesafe.config.Config c) {
      this.admin = c.hasPathOrNull("admin") ? new Agent.Admin(c.getConfig("admin")) : new Agent.Admin(com.typesafe.config.ConfigFactory.parseString("admin{}"));
      this.internal = c.hasPathOrNull("internal") ? new Agent.Internal(c.getConfig("internal")) : new Agent.Internal(com.typesafe.config.ConfigFactory.parseString("internal{}"));
      this.metrics = c.hasPathOrNull("metrics") ? new Agent.Metrics(c.getConfig("metrics")) : new Agent.Metrics(com.typesafe.config.ConfigFactory.parseString("metrics{}"));
      this.name = c.hasPathOrNull("name") ? c.getString("name") : "";
      this.pathConfigs = $_LAgent_PathConfigs$Elm(c.getList("pathConfigs"));
      this.proxy = c.hasPathOrNull("proxy") ? new Agent.Proxy(c.getConfig("proxy")) : new Agent.Proxy(com.typesafe.config.ConfigFactory.parseString("proxy{}"));
    }
    ...
    public static class Internal {
      ...
      public final int scrapeChannelBacklogUnhealthySize;
      ...
      public Internal(com.typesafe.config.Config c) {
        ...
        this.scrapeChannelBacklogUnhealthySize = c.hasPathOrNull("scrapeChannelBacklogUnhealthySize") ? c.getInt("scrapeChannelBacklogUnhealthySize") : 25;
        this.zipkin = c.hasPathOrNull("zipkin") ? new Internal.Zipkin(c.getConfig("zipkin")) : new Internal.Zipkin(com.typesafe.config.ConfigFactory.parseString("zipkin{}"));
      }
    ...
    public static class Metrics {
      ...
      public Metrics(com.typesafe.config.Config c) {
        ...
        this.grpc = c.hasPathOrNull("grpc") ? new Metrics.Grpc(c.getConfig("grpc")) : new Metrics.Grpc(com.typesafe.config.ConfigFactory.parseString("grpc{}"));
  ...
  public static class Proxy2 {
    ...
    public Proxy2(com.typesafe.config.Config c) {
      this.admin = c.hasPathOrNull("admin") ? new Proxy2.Admin2(c.getConfig("admin")) : new Proxy2.Admin2(com.typesafe.config.ConfigFactory.parseString("admin{}"));
      this.agent = c.hasPathOrNull("agent") ? new Proxy2.Agent2(c.getConfig("agent")) : new Proxy2.Agent2(com.typesafe.config.ConfigFactory.parseString("agent{}"));
      this.http = c.hasPathOrNull("http") ? new Proxy2.Http(c.getConfig("http")) : new Proxy2.Http(com.typesafe.config.ConfigFactory.parseString("http{}"));
      this.internal = c.hasPathOrNull("internal") ? new Proxy2.Internal2(c.getConfig("internal")) : new Proxy2.Internal2(com.typesafe.config.ConfigFactory.parseString("internal{}"));
      this.metrics = c.hasPathOrNull("metrics") ? new Proxy2.Metrics2(c.getConfig("metrics")) : new Proxy2.Metrics2(com.typesafe.config.ConfigFactory.parseString("metrics{}"));
    }
    ...
    public static class Internal2 {
      ...
      public final int scrapeRequestBacklogSize;
      ...
      public Internal2(com.typesafe.config.Config c) {
        this.blitz = c.hasPathOrNull("blitz") ? new Internal2.Blitz(c.getConfig("blitz")) : new Internal2.Blitz(com.typesafe.config.ConfigFactory.parseString("blitz{}"));
        this.maxAgentInactivitySecs = c.hasPathOrNull("maxAgentInactivitySecs") ? c.getInt("maxAgentInactivitySecs") : 15;
        this.scrapeRequestBacklogSize = c.hasPathOrNull("scrapeRequestBacklogSize") ? c.getInt("scrapeRequestBacklogSize") : 128;
        ...
        this.zipkin = c.hasPathOrNull("zipkin") ? new Internal2.Zipkin2(c.getConfig("zipkin")) : new Internal2.Zipkin2(com.typesafe.config.ConfigFactory.parseString("zipkin{}"));
      }
    ...
    public static class Metrics2 {
      ...
      public Metrics2(com.typesafe.config.Config c) {
        ...
        this.enabled = c.hasPathOrNull("enabled") && c.getBoolean("enabled");
        this.garbageCollectorExportsEnabled = c.hasPathOrNull("garbageCollectorExportsEnabled") && c.getBoolean("garbageCollectorExportsEnabled");
        this.grpc = c.hasPathOrNull("grpc") ? new Metrics2.Grpc2(c.getConfig("grpc")) : new Metrics2.Grpc2(com.typesafe.config.ConfigFactory.parseString("grpc{}"));
        this.memoryPoolsExportsEnabled = c.hasPathOrNull("memoryPoolsExportsEnabled") && c.getBoolean("memoryPoolsExportsEnabled");
        this.path = c.hasPathOrNull("path") ? c.getString("path") : "metrics";
